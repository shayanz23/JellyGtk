...
public class Configuration {
    ...
    public List<string> grouped_folders { get; set; }
    public string subtitle_mode { get; set; }
    public bool display_collections_view { get; set; }
    public bool enable_local_password { get; set; }
    public List<string> ordered_views { get; set; }
    public List<string> latest_items_excludes { get; set; }
    public List<string> my_media_excludes { get; set; }
...
public class Policy {
    ...
    public List<string> blocked_tags { get; set; }
    public bool enable_user_preference_access { get; set; }
    public List<string> access_schedules { get; set; }
    public List<string> block_unrated_items { get; set; }
    ...
    public List<string> enable_content_deletion_from_folders { get; set; }
    ...
    public List<string> enabled_devices { get; set; }
    public bool enable_all_devices { get; set; }
    public List<string> enabled_channels { get; set; }
    public bool enable_all_channels { get; set; }
    public List<string> enabled_folders { get; set; }
    ...
    public List<string> blocked_channels { get; set; }
